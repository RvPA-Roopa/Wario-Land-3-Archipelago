...
## Desert Ruins
**Unlock:** Blue Tablet + Green Tablet *(combined: Tablets)*
...
## The Volcano's Base
**Unlock:** Top Half of Scroll + Bottom Half of Scroll *(combined: Scroll)*
...
## The West Crater
**Unlock:** Tusk Blue + Tusk Red + Green Flower *(combined: Tusk Set)*
...
## The Grasslands
**Unlock:** Gear 1 + Gear 2 *(combined: Gears)*
...
## Tower of Revival
**Unlock:** Skull Ring Red + Skull Ring Blue *(combined: Skull Ring)*
...
## The Steep Canyon
**Unlock:** Trident + Yellow Book *(combined: Trident & Yellow Book)*
...
## The Frigid Sea
**Unlock:** Blue Book + Magic Wand *(combined: Blue Book & Magic Wand)*
...
## Castle of Illusions
**Unlock:** Lantern + Magical Flame *(combined: Lantern & Magical Flame)*
...
## Victory Condition
Collect the required number of Music Boxes (Yellow, Blue, Green, Red, Gold) + Overalls x1 + Grab x2.
