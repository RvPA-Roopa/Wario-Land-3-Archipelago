...
class DifficultyOptions(Choice):
    ...
    Hard Tricks: The logic assumes that the player will both know knowledge checks and be able to do more difficult tricks, like jumping off of a thrown enemy in midair.
    """
